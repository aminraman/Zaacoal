...
export default function ContactModal({ isOpen, onClose }) {
  ...
  const contacts = [
    {
      icon: <Phone className="w-6 h-6 text-orange-800" />,
      title: "Call Us",
      detail: "+233 26 582 4555",
      action: "tel:+233265824555",
    },
    {
      icon: <Mail className="w-6 h-6 text-orange-800" />,
      title: "Email Us",
      detail: "info@zaacoal.com",
      action: "mailto:info@zaacoal.com",
    },
    {
      icon: <MessageSquare className="w-6 h-6 text-orange-800" />,
      title: "WhatsApp",
      detail: "+233 50 700 5551",
      action: "https://wa.me/233507005551?text=Hello%20Zaacoal%20team,%20I%20would%20like%20to%20make%20an%20inquiry.",
    },
    {
